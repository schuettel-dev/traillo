...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference("ListItem.count") do
      post list_items_url, params: { list_item: { list_position: @list_item.list_position, title: @list_item.title } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { list_position: @list_item.list_position, title: @list_item.title } }
